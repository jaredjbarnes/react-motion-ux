  ...
  _createClass(TransitionMediator, [{
    ...
    value: function createAnimations() {
      ...
      var animations = Object.keys(properties).map(function (key) {
        ...
        return _objectSpread({}, property, {
          ...
          easing: _easeOut.default[property.easing] || _easeOut.default.expo
        });
      });
      return animations;
    }
    ...
    value: function createAdjustedAnimations() {
      ...
      var animations = Object.keys(newOptions).map(function (key) {
        ...
        if (shouldRedirect) {
          new _motionUx.BlendedEasing({
            easingA: _easeOut.default[oldOption.easing] || _easeOut.default.expo,
            easingB: _easeOut.default[option.easing] || _easeOut.default.expo,
