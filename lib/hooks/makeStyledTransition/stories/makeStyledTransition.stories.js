...
exports.NonMatchingValues = exports.NonMatchingProperties = exports.NullStateName = exports.InvalidStateName = exports.TrafficLightDemo = exports.MultipleNamedIconDemo = exports.NamedIconDemo = exports.DisplayNoneExample = exports.MenuDemo = exports.OptionButtonDemo = exports.OptionDemo = exports.ButtonDemo = exports.SwitchDemo = exports.InitialState = exports.default = void 0;
...
var useMissingStyledTransition = (0, _.default)({
  opened: {
    opacity: "1"
  },
  closed: {
...
var NonMatchingProperties = function NonMatchingProperties() {
  var _useState5 = (0, _react.useState)("opened"),
      _useState6 = _slicedToArray(_useState5, 2),
      state = _useState6[0],
      setState = _useState6[1];

  var ref = useMissingStyledTransition(state);
  setTimeout(function () {
    setState("closed");
  }, 0);
  return _react.default.createElement("div", {
...
exports.NonMatchingProperties = NonMatchingProperties;
var useNonMatchingValuesStyledTransition = (0, _.default)({
  opened: {
    backgroundColor: "#000"
  },
  closed: {
...
var NonMatchingValues = function NonMatchingValues() {
  var _useState7 = (0, _react.useState)("opened"),
      _useState8 = _slicedToArray(_useState7, 2),
      state = _useState8[0],
      setState = _useState8[1];

  var ref = useNonMatchingValuesStyledTransition(state);
  setTimeout(function () {
    setState("closed");
  }, 0);
  return _react.default.createElement("div", {
...
exports.NonMatchingValues = NonMatchingValues;
//# sourceMappingURL=makeStyledTransition.stories.js.map