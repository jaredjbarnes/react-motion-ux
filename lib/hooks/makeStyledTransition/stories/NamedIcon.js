...
var NamedIcon = function NamedIcon() {
  ...
  var lineRef = useLineStyledMotion(state, {
    props: {
      width: width
    }
  });
  var containerRef = useContainerStyledMotion(state, {
    props: {
      width: width
    }
  });
  var nameRef = useNameStyledMotion(state);
  var iconRef = useIconStyledMotion(state, {
    props: {
